  ...
  return (
    <div className = 'py-25 flex items-center justify-center'>
        <div>
            ...
            <Button onClick={register} className='w-full bg-[#DB4444] rounded-lg py-5 mt-7 mb-5'>
                Create Account
            </Button>
            <div className='flex items-center justify-center gap-3 border border-[#DB4444] rounded-lg py-2'>
