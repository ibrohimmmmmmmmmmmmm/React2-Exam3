...
function ServiceCard({ icon: Icon, title, desc }: { icon: React.ElementType; title: string; desc: string }) {
  return (
    <div className='flex flex-col items-center text-center gap-3 px-4'>
      ...
      <div>
        <p className='font-extrabold text-sm tracking-wide text-gray-900 uppercase'>{title}</p>
...
export default function NewArrival() {
  return (
    <div className='px-4 sm:px-6 md:px-[100px] py-10'>
      ...
      <h2 className='text-2xl sm:text-[32px] font-bold text-gray-900 mb-6'>New Arrival</h2>

      {/* ── MOBILE: stacked cards ── */}
      <div className='flex flex-col gap-3 sm:hidden'>

        {/* PS5 */}
        <div className='relative h-[220px] rounded overflow-hidden bg-black group cursor-pointer'>
          ...
          <div className='absolute bottom-0 left-0 p-5 z-10'>
            ...
            <p className='text-white/60 text-xs mb-3'>Black and White version of the PS5 coming out on sale.</p>
        ...
        {/* Women */}
        <div className='relative h-[220px] rounded overflow-hidden bg-black group cursor-pointer'>
          <img src={WOMEN_IMG} alt="Women's Collections" className='absolute inset-0 w-full h-full object-cover object-top opacity-80 group-hover:scale-105 transition-transform duration-500' />
          <div className='absolute inset-0 bg-gradient-to-t from-black/80 via-black/10 to-transparent' />
          <div className='absolute bottom-0 left-0 p-5 z-10'>
            <h3 className='text-white font-bold text-xl mb-1'>Women's Collections</h3>
            <p className='text-white/60 text-xs mb-3'>Featured woman collections that give you another vibe.</p>
            <button className='text-white text-sm font-semibold border-b border-white pb-0.5 hover:text-gray-300'>Shop Now</button>
          </div>
        </div>

        {/* Speakers */}
        <div className='relative h-[180px] rounded overflow-hidden bg-black group cursor-pointer'>
          ...
          <div className='absolute bottom-0 left-0 p-5 z-10'>
            ...
            <p className='text-white/60 text-xs mb-3'>Amazon wireless speakers</p>
            <button className='text-white text-sm font-semibold border-b border-white pb-0.5 hover:text-gray-300'>Shop Now</button>
          </div>
        </div>
        ...
        <div className='relative h-[180px] rounded overflow-hidden bg-black group cursor-pointer'>
          ...
          <div className='absolute bottom-0 left-0 p-5 z-10'>
            ...
            <p className='text-white/60 text-xs mb-3'>GUCCI INTENSE OUD EDP</p>
            <button className='text-white text-sm font-semibold border-b border-white pb-0.5 hover:text-gray-300'>Shop Now</button>
          </div>
        </div>
      </div>
      ...
      <div className='hidden sm:grid grid-cols-2 gap-4' style={{ height: 520 }}>
        ...
        <div className='flex flex-col gap-4 h-full'>
          ...
          {/* Speakers + Perfume — bottom half side by side */}
          <div className='flex gap-4 flex-1'>
            <div className='relative rounded overflow-hidden bg-black group cursor-pointer flex-1'>
              ...
              <div className='absolute bottom-0 left-0 p-5 z-10'>
                <h3 className='text-white font-bold text-lg mb-1'>Speakers</h3>
                <p className='text-white/60 text-xs mb-2'>Amazon wireless speakers</p>
                <button className='text-white text-sm font-semibold border-b border-white pb-0.5 hover:text-gray-300'>Shop Now</button>
              </div>
            </div>
            ...
            <div className='relative rounded overflow-hidden bg-black group cursor-pointer flex-1'>
              ...
              <div className='absolute bottom-0 left-0 p-5 z-10'>
                <h3 className='text-white font-bold text-lg mb-1'>Perfume</h3>
                <p className='text-white/60 text-xs mb-2'>GUCCI INTENSE OUD EDP</p>
                <button className='text-white text-sm font-semibold border-b border-white pb-0.5 hover:text-gray-300'>Shop Now</button>
              </div>
            </div>
          </div>
