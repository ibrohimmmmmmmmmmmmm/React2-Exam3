  ...
  return (
    <>
      ...
      <div className='flex flex-col sm:hidden px-4 pt-4 pb-6'>
        ...
        {/* Search bar */}
        <div className='flex items-center border border-gray-300 rounded-sm px-3 py-2 mb-4 bg-white'>
          <input
            type='text'
            placeholder='Search'
            value={search}
          ...
          />
          <Search size={18} className='text-gray-500 ml-2 flex-shrink-0' />
        </div>
          ...
          <div className='flex flex-wrap gap-2 mb-6'>
            {filtered.map((cat) => (
              <button
                ...
                className='flex items-center gap-1 px-3 py-1.5 border border-gray-300 rounded-sm text-sm text-gray-700 hover:border-[#DB4444] hover:text-[#DB4444] transition-colors'
              >
                {cat.categoryName}
        ...
        {/* iPhone promo banner */}
        <div className='relative w-full rounded-sm overflow-hidden bg-black min-h-[320px] flex flex-col'>
          {/* Text content */}
          <div className='px-6 pt-8 pb-4 z-10'>
            <div className='flex items-center gap-2 mb-3'>
              ...
              <span className='text-white/80 text-xs'>iPhone 14 Series</span>
            </div>
            ...
            <button
              ...
              className='flex items-center gap-2 text-white text-sm font-semibold border-b border-white pb-0.5 w-fit hover:text-gray-300 transition-colors'
            >
